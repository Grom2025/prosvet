                    ...
                    <td align="right">
                        <div class="btn-group dropstart">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark px-3">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="{{ url('/').'/rooles' }}">Цена</a></li>
...
<footer class="container py-5">
    <div class="row">
        <div class="col-6 col-md">
            ...
            <small class="d-block mb-3 text-body-secondary">&copy; ProSvet 2025</small>
        ...
        <div class="col-auto">
            ...
            <small class="d-block mb-3 text-white">Telegram/WhatsApp</small>
